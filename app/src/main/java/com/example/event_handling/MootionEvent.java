...
public class MootionEvent extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mootion_event);

        ConstraintLayout myLayout = findViewById(R.id.activity_mootion_event);
